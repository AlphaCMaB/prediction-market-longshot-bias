...
OUT_CSV = PROCESSED_DIR / "p_hat_batch.csv"
REPORT_PATH = OUTPUTS_DIR / "p_hat_batch_report.md"
...
def write_report(rows: list[dict]) -> None:
    ...
    lines = []
    lines.append("# p_hat Batch Report")
    lines.append("")
...
def main() -> None:
    ...
    print("\n" + "=" * 80)
    print("p_hat batch extraction complete")
    print("Rows:", len(rows))
