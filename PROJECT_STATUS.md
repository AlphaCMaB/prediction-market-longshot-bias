...
1. Obtain explicit project-owner approval, modification, or rejection of PR1
   and PR2 using the completed outcome-blind validation diagnostics.
2. Only after approval, version the final deterministic rule specifications
   and apply them without outcome access.
3. Then construct horizons
